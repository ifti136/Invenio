...
> **Status: superseded.** This document covers the original
> implementation spec for **Phases 1–5 only**. Phases 1.5 (Liquid
> Glass theme) and 6.0–7.0 (visual alignment, pop-up fixes,
> branding) are not in this file; they are documented in
> [`../CHANGELOG.md`](../CHANGELOG.md) and [`../HISTORY.md`](../HISTORY.md).
> For the per-file contracts in the as-shipped product, see
> [`03_code_specs.md`](03_code_specs.md). For a human-readable
> overview of the same architecture, see
> [`../ARCHITECTURE.md`](../ARCHITECTURE.md).
>
> **Use this file as a code-shape reference only.** The Phase 1–5
> code blocks below are illustrative of the original design intent
> and are kept verbatim for that purpose. They were the source of
> the implementation; they are not the documentation of the
